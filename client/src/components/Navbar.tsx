...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav 
        className={`navbar fixed w-full z-50 text-white transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 md:px-6 py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="flex items-center space-x-2">
              <span className="font-playfair text-2xl font-bold text-accent">Imran's Restaurant</span>
            </Link>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed top-0 right-0 w-[70%] h-full bg-primary z-50 p-6 shadow-xl"
          >
